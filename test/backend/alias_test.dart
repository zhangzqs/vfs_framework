...
void main() {
  ...
  group('test AliasFileSystem', () {
    ...
    test('should check file existence correctly', () async {
      ...
      expect(
        await aliasFs.exists(Path.fromString('/subdir/file2.txt')),
        isTrue,
      );
      expect(
        await aliasFs.exists(Path.fromString('/nonexistent.txt')),
        isFalse,
      );
    ...
    test('should write files correctly', () async {
      ...
      // 验证文件被写入到正确的位置
      expect(
        await baseFs.exists(Path.fromString('/base/new_file.txt')),
        isTrue,
      );
    ...
    test('should handle root alias correctly', () async {
      ...
      expect(
        await rootAliasFs.exists(Path.fromString('/root_file.txt')),
        isTrue,
      );
      expect(
        await rootAliasFs.exists(Path.fromString('/base/file1.txt')),
        isTrue,
      );
    ...
    test('should handle nested subdirectory correctly', () async {
      ...
      expect(
        await nestedAliasFs.exists(Path.fromString('/file1.txt')),
        isFalse,
      );
